...
The [Eliza Plugin](https://github.com/multiversx/mx-agent-kit) features secure transaction signing with automatic nonce management and real-time status tracking, enabling trustless AI operations on-chain.
...
- [Main Website](https://multiversx.com)
- [Technical Documentation](https://docs.multiversx.com)
- [GitHub Organization](https://github.com/MultiversX)
- [Ecosystem Partners](https://multiversx.com/ecosystem/partners)
- [Blockchain Explorer](https://explorer.multiversx.com)
