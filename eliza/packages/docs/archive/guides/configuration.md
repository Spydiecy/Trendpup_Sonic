...
TWITTER_ENABLE_POST_GENERATION=true # Auto tweet generation
TWITTER_POST_INTERVAL_MIN= # Min post interval (min), default: 90
TWITTER_POST_INTERVAL_MAX= # Max post interval (min), default: 180
TWITTER_POST_IMMEDIATELY= # Post immediately, default: false
